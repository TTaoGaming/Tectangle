...
export class CameraManager {
  ...
  async start() {
    ...
    // Prefer MediaPipe Camera which has optimized onFrame handling when included.
    if (typeof Camera !== "undefined") {
      try {
        ...
        console.warn("CameraManager: MediaPipe Camera failed, falling back to getUserMedia", err);
        this._camera = null;
      }
    }
