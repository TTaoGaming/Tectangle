...
Status: Draft
Review started: 
Expires:  (auto-expire after 7 days)
...
## Immediate TODOs
- [ ] Create docs/import_manifest.md listing legacy sources + status.
...
- Subsystem blackboards once created (pinch, anchor, telemetry, prediction).
