// Quick smoke to verify P1/P2 lock-in using controller_router_lab.html
// Usage: node scripts/check_p1p2_lockin.js
...
(async () => {
  ...
  // Capture pinch events and postMessages
  await page.exposeFunction('nodeLog', (msg) => console.log('[page]', msg));
  ...
  // Require at least two downs and two distinct controller IDs P1/P2
